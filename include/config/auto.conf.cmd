deps_config := \
	...
	drivers/input/touchscreen/focaltech/ft3519/Kconfig \
	...
	drivers/battery/charger/hl7132_charger/Kconfig \
	...
	drivers/gpu/drm/samsung/panel/s6e8fc3/Kconfig \
	...
	drivers/samsung/knox/hdm/Kconfig \
	drivers/samsung/knox/Kconfig \
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/usr/bin/aarch64-linux-gnu- --gcc-toolchain=/usr -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "llvm-nm"
include/config/auto.conf: FORCE
